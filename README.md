...
-Run local LLM-powered RAG in Colab without compilation
-Experiment with GGUF models and llama.cpp
-Build document-question-answering systems using LlamaIndex
